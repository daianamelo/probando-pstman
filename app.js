...
app.put("/people/:index", (req, res) => {
  ...
  // Actualiza el elemento correspondiente en el array con los datos proporcionados en el cuerpo de la solicitud
...
app.delete("/people/:index", (req, res) => {
   ...
   */
    ...
    // Elimina el elemento correspondiente en el array
    people.splice(index, 1);
  
    res.json({ message: "Objeto eliminado con éxito" });
});
